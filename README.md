...
- Whenever code for Tessel changed, don't forget to re-deploy by using the command mentioned on step#7.
...
- USB_PORT_ERROR or something similar error, unplug and re-plug Tessel would help.
